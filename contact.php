      ...
      <section>
          <div class="container contact ribbon-margin">
              ...
              <div id="success-message" class="col-12">
                  <img id="checkmark" src="img/contact/checkmark.png" />
                  <span id="success-message-text">Your message has been sent. Thank you!</span>
              </div>
              <div class="col-3"></div>
              <div class="col-6">
                  ...
                  xhttp.onreadystatechange = function() {
                      if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById('success-message').style.display = "block";
                          ...
                          document.getElementById("success-message-text").innerText = "Sorry but you need to fill in all the fields!";
