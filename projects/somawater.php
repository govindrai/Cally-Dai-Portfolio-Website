    ...
    <div class="w-container">
      ...
      <div class="project-body" data-ix="button-appears">
        <div class="w-richtext">
          ...
          <p>Soma Water&nbsp;designs water filters and beautifully aesthetic vessels. Each purchase supports water-related charities with option of&nbsp;bi-monthly&nbsp;filter replacement subscriptions.</p>
          <h4>Context</h4>
          <p>Desktop landing page.</p>
          <h4>Goal</h4>
          <p>Soma is currently experiencing&nbsp;a high drop off rate for their promotion and a low&nbsp;conversion rate of email subscribers. We aim to increase comprehension and&nbsp;increase subscription visibility.</p>
          <h4>Constraints</h4>
          <p>6-week project. Design was constrained to goals of the growth team: SEO and conversion.</p>
          <h4>Role</h4>
          <p>Product Designer along with 4 other designers.</p>
          <h4>Process</h4>
          <p>Click below to skip ahead to perspective sections.</p>
        </div>
        <div class="process soma w-row">
          ...
          <div class="w-col w-col-2 w-col-small-2 w-col-tiny-2">
            <a class="problem process-link-block w-inline-block" href="javascript:;" onclick="document.location.hash='define-problem';"></a>
          </div>
          <div class="w-col w-col-2 w-col-small-2 w-col-tiny-2">
        ...
        <div class="w-richtext">
          <h4>Results</h4>
          <p>Before and after shown below. Click through to see larger images detailing problems we faced and the changes we made.</p>
        </div>
        <div class="w-row">
            ...
            <a class="w-inline-block w-lightbox" href="#"><img src="images/Soma Water anotated Before.png">
              <script class="w-json" type="application/json">
                { "items": [{
                  ...
                  "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577da00c3a9f1a3f153361d5_Soma%20Water%20anotated%20Before.png",
                  "fileName": "577da00c3a9f1a3f153361d5_Soma Water anotated Before.png",
                  "origFileName": "Soma Water anotated Before.png",
                  "width": 1247,
                  "height": 2167,
                  "fileSize": 866816,
                  "type": "image",
            ...
            <a class="w-inline-block w-lightbox" href="#"><img src="images/Soma annotated after.png">
              <script class="w-json" type="application/json">
                { "items": [{
                  ...
                  "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577da053044a522433e27355_Soma%20annotated%20after.png",
                  "fileName": "577da053044a522433e27355_Soma annotated after.png",
                  "origFileName": "Soma annotated after.png",
                  "width": 1250,
                  "height": 2500,
                  "fileSize": 1360301,
                  "type": "image",
        ...
        <div class="w-richtext">
          ...
          <p>First, we aimed to create a persona to help guide our design decisions. Soma&nbsp;provided demographic data of their existing audience to serve as a basis for our persona. The data was diverse and broad, so we decided to create two personas to represent the statistics. Click on personas below to see larger images.</p>
        </div>
        <div class="w-row">
          <div class="project-image-side-by-side w-col w-col-6">
            <a class="w-inline-block w-lightbox" href="#"><img src="images/Sarah.png">
              <script class="w-json" type="application/json">
                { "items": [{
                  ...
                  "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577da12fe3f0f3221582f185_Sarah.png",
                  "fileName": "577da12fe3f0f3221582f185_Sarah.png",
                  "origFileName": "Sarah.png",
                  "width": 602,
                  "height": 889,
                  "fileSize": 186641,
                  "type": "image",
            ...
            <a class="w-inline-block w-lightbox" href="#"><img src="images/James.png">
              <script class="w-json" type="application/json">
                { "items": [{
                  ...
                  "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577da154e3f0f3221582f194_James.png",
                  "fileName": "577da154e3f0f3221582f194_James.png",
                  "origFileName": "James.png",
                  "width": 602,
                  "height": 889,
                  "fileSize": 182355,
                  "type": "image",
        ...
        <div class="w-richtext">
          ...
          <h3>Next Steps</h3>
          <p>When handing off this project, we encourage Soma’s in-house team to do the following:</p>
          <p>1.) &nbsp;A/B test this landing page against their original page to determine clear improvement
            <br>2.) &nbsp;Ensure copy on other pages of the site, including the checkout page following this page, is consistent with the copy on this page
            <br>3.) &nbsp;Consider deprioritizing email subscriptions to eliminate competing call-to-actions</p>
          <h2>Reflection</h2>
          <p>As my first experience working within a team,&nbsp;I learned how to respectfully communicate my thoughts with fellow designers and how to give and receive critique in a constructive way. I also realized the importance and power of user testing to address ambiguous problems.</p>
          <p>Delivering a project alongside a growth team was also a unique challenge that taught me how to communicate with&nbsp;stakeholders whose goals differed than my own. I realized knowing how to communicate appropriately and respectfully with others is the best attribute I can have as a designer.</p>
        </div>
      </div>
    </div>
  </div>
