    ...
    <div class="w-container">
      ...
      <div class="project-body" data-ix="button-appears">
        <div class="w-richtext">
          ...
          <p>Glifft curates items to help people choose thoughtful gifts. The team is creating a new mobile application centered on everyday, casual gifting through a machine-learning algorithm that adapts to users’ preferences.</p>
          <h4>Context</h4>
          <p>Mobile application</p>
          <h4>Goal</h4>
          <p>We are designing an intuitive minimum viable product (MVP) that will resonate with users.</p>
          <h4>Constraints</h4>
          <p>Timeframe is 3 weeks to low-fidelity wireframes and 6&nbsp;weeks to completion.</p>
          <h4>Role</h4>
          <p>Product Designer with 10 other designers. Focused on UX and UI, including visual design and branding.</p>
          <h4>Process</h4>
          <p>Click below to skip ahead to the perspective sections.</p>
        </div>
        ...
        <a class="w-inline-block w-lightbox" href="#"><img src="images/final hifi flow.png">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577eb91a97ba26ad3cbfbf7b_final%20hifi%20flow.png",
              "fileName": "final hifi flow.png",
              "origFileName": "final hifi flow.png",
              "width": 1250,
              "height": 1000,
              "fileSize": 231183,
              "type": "image",
        ...
        <a class="w-inline-block w-lightbox" href="#"><img class="project-body-image" src="images/glifft persona.png" width="80%">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577eba5a86a452923c8d3f7b_glifft%20persona.png",
              "fileName": "glifft persona.png",
              "origFileName": "glifft persona.png",
              "width": 1320,
              "height": 1050,
              "fileSize": 916180,
              "type": "image",
        ...
        <div class="w-richtext">
          <p>To ensure our persona is accurate, we should have conducted user interviews to validate the needs and the goals of our ideal user. However, since this is app has not yet been made and thus does not have a user base, we assumed 'Julia' to be true.</p>
        ...
        <a class="w-inline-block w-lightbox" href="#"><img class="project-body-image" src="images/Glifft Flow.png" width="80%">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577ebcc486a452923c8d4401_Glifft%20Flow.png",
              "fileName": "Glifft Flow.png",
              "origFileName": "Glifft Flow.png",
              "width": 1200,
              "height": 910,
              "fileSize": 275238,
              "type": "image",
        ...
        <a class="w-inline-block w-lightbox" href="#"><img class="project-body-image" src="images/lofi mockups annotated.png" width="80%">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577ebcf397ba26ad3cbfc877_lofi%20mockups%20annotated.png",
              "fileName": "lofi mockups annotated.png",
              "origFileName": "lofi mockups annotated.png",
              "width": 1400,
              "height": 1024,
              "fileSize": 256611,
              "type": "image",
        ...
        <div class="w-richtext">
          <p>Evidently, the flow is very robust with many features in place. We later revised our scope on this project when we moved into building our prototype.</p>
        ...
        <a class="w-inline-block w-lightbox" href="#"><img class="project-body-image" src="images/lofi to proto.png" width="80%">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577ebe5f86a452923c8d48eb_lofi%20to%20proto.png",
              "fileName": "lofi to proto.png",
              "origFileName": "lofi to proto.png",
              "width": 1200,
              "height": 900,
              "fileSize": 260859,
              "type": "image",
        ...
        <a class="w-inline-block w-lightbox" href="#"><img class="project-body-image" src="images/changes made.png" width="80%">
          <script class="w-json" type="application/json">
            { "items": [{
              ...
              "cdnUrl": "https://daks2k3a4ib2z.cloudfront.net/571abfc80a8819820933b957/577ebf1386a452923c8d4d00_changes%20made.png",
              "fileName": "changes made.png",
              "origFileName": "changes made.png",
              "width": 1200,
              "height": 900,
              "fileSize": 216641,
              "type": "image",
        ...
        <div class="w-richtext">
          <p>To make sure these changes work to our advantage, we would need to test the new prototype with at least another 7 users. However, because of our timeframe, we delivered the changes without testing, making sure to let our client know that their next step should be to test the new prototype.</p>
          <h3>Next Steps</h3>
          <p>The final mockups were given to the client, along with our low-fidelity wireframes that mapped out additional features to the app. We also made aware the following as next steps to the client:</p>
          <p>1. Test changes to see if the results from user testing and comprehension improves
        ...
        <div class="w-richtext">
          ...
          <p>Throughout this project, I also learned how to communicate with clients that were founders and engineers. The Glifft team was very curious, involved, and supportive. However, sometimes their high investment and inquisition called for us to go beyond our scope. We learned to be respectfully firm and honest in our communications in order not to overwork our team.</p>
        </div>
      </div>
    </div>
  </div>
