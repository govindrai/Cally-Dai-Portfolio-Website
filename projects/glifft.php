...
<body>
  <?php require_once(__DIR__ . '/../php/navigation.php'); ?>
    <body>
       ...
       <section class="glifft-section-highlight">
         <div class="container">
           <div class="col-1"></div>
           <div class="col-10">
             <h2>Summary</h2>
             <div class="left-align-spacer">
               <img class="project-body-image" width="100px" src="images/glifft/logo.png">
               <p>Glifft helps you curate personalized gift lists to help you choose the right present for anyone for any occasion.</p>
             </div>
           </div>
           <div class="col-1"></div>
           <div class="col-1"></div>
           <div class="col-5">
             <div class="left-align-spacer">
               <h3>Goal</h3>
               <p>Design the MVP of a mobile app for iOS centered on everyday, casual gifting through machine-learning.</p>
             </div>
           </div>
           <div class="col-5">
             <div class="left-align-spacer">
               <h3>Role</h3>
               <p>Product Designer with 10 other designers with focus on UX and UI, including visual design and branding.</p>
             </div>
           </div>
           <div class="col-1"></div>
           <div class="col-1"></div>
        ...
        <section id="research">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/research.svg">
        ...
        <section id="ideate">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/ideate.svg">
                  <div class="process-name">
                    <h3>Ideate & Explore</h3>
                  </div>
                </div>
                <p>We began sketching our ideas with a couple rounds of Crazy 8's, where we quickly sketched wireframes, shared ideas, and iterated. Features were refined as we broke off into smaller groups to create lo-fi wireframes.</p>
        ...
        <section id="branding">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/branding.svg">
                  <div class="process-name">
                    <h3>Branding & Visuals</h3>
                  </div>
                </div>
                <p>We had little visuals to work with so I broke off with a subgroup to pilot a branding workshop. We would have loved to have the Founders there for feedback, but we needed to operate quickly and they entrusted us to do this on our own.</p>
                <p>Generating words from Glifft's current branding and drawing inspiration from similar companies, we bundled them into groups and came up with 4 key brand attributes.</p>
                </div>
            </div>
            <div class="col-1"></div>
            <div class="col-1"></div>
        ...
        <section id="mockup">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/mockup.svg">
                  <div class="process-name">
                    <h3>Hifi Mockups & Prototype</h3>
                  </div>
                </div>
        ...
        <section id="testing">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/testing.svg">
                  <div class="process-name">
                    <h3>Test & Iterate</h3>
                  </div>
                </div>
        ...
        <section id="next-steps">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-glifft">
                  <img class="process-icon" src="images/glifft/icons/next-steps.svg">
                  <div class="process-name">
                    <h3>Next steps</h3>
                  </div>
                </div>
                <p>The final mockups were given to the client with the following next steps:</p>
                <li>Test changes to see if the results from user testing and comprehension improves</li>
                ...
                <p>"[The Glifft team] really worked from first principles and rethought the whole premise of our app. [They have] far exceed our expectations -- delivering the design on time, with incredibly high quality, all the while communicating clearly with us, the client."</p>
                <p>-- Sourav Dey, Glifft Co-Founder</p>
              </div>
            </div>
            <div class="col-1"></div>
          </div>
        ...
        <section class="glifft-section-highlight">
          <div class="container">
            ...
            <div class="col-10">
              <h2>Reflection</h2>
              <div class="left-align">
                <p>Working in a team of 11 designers was challenging for various reasons. This tremendous opportunity taught me:</p>
                <li>Be firm in the design decisions you believe in, but also realize the product is a combination of everyone's best ideas</li>
                <li>Determine a realistic scope earlier on in the project (quality over quantity), especially when designing the MVP</li>
                <li>UX and UI designers should work together from the beginning to ensure proper communication throughout process</li>
                <li>When working with non-designers, communicate very clearly importance of process and reasons for design decisions</li>
              </div>
            </div>
            <div class="col-1"></div>
          </div>
