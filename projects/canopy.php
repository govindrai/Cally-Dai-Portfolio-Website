  ...
  <head>
    ...
    <body>
      <?php require_once('../php/navigation.php'); ?>
       ...
       <section class="canopy-section-highlight">
         <div class="container">
           <div class="col-1"></div>
           <div class="col-10">
             <h2>Summary</h2>
             <div class="left-align-spacer">
               <img class="project-body-image" width="120px" src="images/canopy/logo.png">
               <p>Canopy is an interactive educational platform dedicated to teaching people about trading stocks.</p>
             </div>
           </div>
           <div class="col-1"></div>
           <div class="col-1"></div>
           <div class="col-5">
             <div class="left-align-spacer">
               <h3>Goal</h3>
               <p>Increase user engagement by creating a course roadmap and introducing interactive components within lessons on a responsive mobile web app.</p>
             </div>
           </div>
           <div class="col-5">
             <div class="left-align-spacer">
               <h3>Role</h3>
               <p>Product Designer with 6 other designers, conducting user research and solving problems for user experience and user interface.</p>
             </div>
           </div>
           <div class="col-1"></div>
           <div class="col-1"></div>
        ...
        <section id="research">
          <div class="container">
           <div class="col-1"></div>
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/research.svg">
                  <div class="process-name">
                    <h3>Research & Validate</h3>
                  </div>
                </div>
                <p>Since Canopy was newly launched and did not have concrete data of its user base, we predicted our ideal user for the product with a provisional persona and conducted user interviews with people who had an interest to learn stock-trading and have used learning platforms in the past. We asked them questions regarding their learning behaviors and previous experiences.</p>
                <p>We found 4 key insights from this process:</p>
                <li>Users wanted short, bite-sized lessons when learning new material</li>
        ...
        <section id="ideate">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/ideate.svg">
                  <div class="process-name">
                    <h3>Ideate</h3>
                  </div>
                </div>
        ...
        <section id="mockup">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/mockup.svg">
                  <div class="process-name">
                    <h3>Wireframe & Review</h3>
                  </div>
                </div>
        ...
        <section id="testing">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/testing.svg">
                  <div class="process-name">
                ...
                <p>Unfortunately, most of the confusion from our users came from misunderstanding the dummy content in the prototype. In our next iteration, we used more relevant copy and iconography.</p>
              </div>
            </div>
            <div class="col-1"></div>
         </div>
       ...
       <section id="iterate">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/iterate.svg">
                  <div class="process-name">
                    <h3>Iterate</h3>
                  </div>
                </div>
        ...
        <section id="next-steps">
          <div class="container">
            ...
            <div class="col-10">
              <div class="left-align">
                <div class="process-title-canopy">
                  <img class="process-icon" src="images/canopy/icons/next-steps.svg">
                  <div class="process-name">
                    <h3>Next steps</h3>
                  </div>
                </div>
                <p>For next steps, we encouraged the Canopy team to:</p>
                <li>Conduct another round of testing using "lesson summary" instead of "cheat sheet" to confirm users' understanding</li>
                <li>Research other forms of engagement to create an even more dynamic learning platform</li>
                <p>The Canopy is now working on implementing the changes we have proposed.</p>
              </div>
            </div>
            <div class="col-1"></div>
          </div>
          ...
          <div class="container">
            ...
            <div class="col-10">
              ...
              <div class="left-align">
                ...
                <p>Working with clients also taught me how to effectively communicate design decisions. I learned to be careful not to use jargon and to explain only things in ways non-designers can digest. Additionally, it is helpful to limit options as to not overwhelm them with a great number of wireframes and mockups.</p>
              </div>
            </div>
            <div class="col-1"></div>
          </div>
